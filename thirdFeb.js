// let data=25
// console.log(data);
// var getdata="riya here";
// console.log(getdata);



        // var is accessible throughout the function (function scoped)
        // let is accessible only within the block (block scoped)
        //const cannot be initialized again (more than once)
...
const obj2={...obj, dob:"18th march"}; //to make it immutable use spread operator
...
console.log("hello u are outside");
    ...
    // map,reduce,filter,find,some,every,forEach
...
higherorder();
    ...
    // function composition (combining multiple functions to creating a new function)
function mul(n){
    return n*2;
}
function add(n){
